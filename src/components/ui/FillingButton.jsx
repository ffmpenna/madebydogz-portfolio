export default function FillingButton({ onClick, text, ...props }) {
  return (
    <button
      {...props}
      onClick={onClick}
      className="group relative px-8 py-4 bg-white text-black font-black uppercase tracking-wider overflow-hidden hover:text-white transition-colors duration-300 cursor-pointer"
    >
